...
# from Utils.edges import ParallelWorkflowEdges
# from Nodes.nodes import ParallelWorkflowNodes
...
#         self.Edges = ParallelWorkflowEdges()
...
#         self.graph.add_conditional_edges("prompt_user", self.Edges.check_user_input, {"Valid": "split", "Invalid": END})      
